...
class MainForm(Form):
	...
	def InitializeComponent(self):
		...
		self._listBox1.Size = System.Drawing.Size(771, 251)
		...
		self._button1.Location = System.Drawing.Point(789, 12)
		...
		self._button2.Location = System.Drawing.Point(789, 99)
		...
		self._button3.Location = System.Drawing.Point(789, 218)
		...
		self.ClientSize = System.Drawing.Size(903, 274)
	...
	def Button1Click(self, sender, e):
		...
		for num in range(1, 20+1):
			...
			cube = num**3
			four = num**(1/4)
			msg = str(round(num, 4)) + "\t\t" + str(round(sq, 4)) + "\t\t" + str(round(sqr, 4)) + "\t\t" + str(round(cube, 4)) + "\t\t" + str(round(four, 4))
