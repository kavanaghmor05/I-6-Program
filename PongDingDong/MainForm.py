...
class MainForm(Form):
	...
	def MainFormKeyDown(self, sender, e):
		...
		if e.KeyCode == Keys.L:
			...
			self._rightscore.Text = "0"
			self._lbltitle.Visible = True
			self._lbltitle.Text = "Everyone Loses!"
	...
	def MainFormLoad(self, sender, e):
		""" TODO: ADD 3(1) UNIQUE SECRETS/CHEATS/EASTER EGGS IN TOTAL, (FINISH MULTIPLAYER, SCOREBOARD), AND DUMMY AI """
		self.balld = 1
		self.ballup = self.R.Next(-4, 5)
		self._timerball.Enabled = False
	...
	def LeftscoreClick(self, sender, e):
		#if e.KeyCode == Keys.D and self.leftscore > 0:
			#self._leftscore - 1
			#self._rightscore - 1
			### shoot the other player's paddel, each point is a shot, if you hit them you both lose a point
			###if you miss you lose two, get below 0 and it is an automatic lose
			pass
